package com.metagards.metagames._AnimalRoulate;
...
import com.metagards.metagames._AnimalRoulate.menu.DialogRulesAnimalRoulette;
...
public class AnimalRoulette_Socket extends BaseActivity implements View.OnClickListener {
...
//            ,R.drawable.ic_animal_wolf
    ...
    private static final String URL = "http://64.227.186.5:3002/animal_roulette";
    Socket mSocket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSocket.connect();
        mSocket.emit("animal_roulette_timer", "animal_roulette_timer");

        Initialization();
        setDataonUser();

        mSocket.on("animal_roulette_timer", new Emitter.Listener() {
            @Override
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (intger == 1) {
                            ...
                            getTextView(R.id.tvStartTimerNew).setText("0");//
                            ...
                            getTextView(R.id.tvStartTimerNew).setText(intger + "");
        ...
        mSocket.on("animal_roulette_status", new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    @Override
...
//      startService();
    ...
    private void initRulesSelectAdapter() {
        ...
        animalRouletteAdapter.onItemSelectListener(new OnItemClickListener() {
            @Override
    ...
    private void setSetRulesValue() {
        ...
        for (int i = 0; i < gameroulate_String.length; i++) {
            ...
            rulesModelList.add(new AnimalRouletteModel(item, item_icon, i + 1, 0, 0, gameInto[i]));
        }
