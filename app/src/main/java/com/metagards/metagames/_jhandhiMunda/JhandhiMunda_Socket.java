...
public class JhandhiMunda_Socket extends BaseActivity implements View.OnClickListener{
    ...
    private static final  String URL = "http://64.227.186.5:3002/jhandi_munda";
    Socket mSocket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSocket.connect();
        mSocket.emit("jhandi_munda_timer", "jhandi_munda_timer");
        ...
        mSocket.on("jhandi_munda_timer", new Emitter.Listener() {
            @Override
        ...
        mSocket.on("jhandi_munda_status", new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    @Override
