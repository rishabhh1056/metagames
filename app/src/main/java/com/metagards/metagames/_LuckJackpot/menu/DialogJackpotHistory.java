...
import com.metagards.metagames._LuckJackpot.Model.JackpotWinHistory;
...
public class DialogJackpotHistory {

    Context context;
    Callback callback;
    private static DialogJackpotHistory mInstance;


    public static DialogJackpotHistory getInstance(Context context) {
        if (null == mInstance) {
            synchronized (DialogJackpotHistory.class) {
                if (null == mInstance) {
                    mInstance = new DialogJackpotHistory(context);
                }
            }
        }
     ...
     */
    public DialogJackpotHistory init(Context context) {
        try {
    ...
    private DialogJackpotHistory initDialog() {
    ...
    public DialogJackpotHistory(Context context) {
        this.context = context;
    }

    public DialogJackpotHistory() {
    }
    Dialog dialog;

    public DialogJackpotHistory show() {
