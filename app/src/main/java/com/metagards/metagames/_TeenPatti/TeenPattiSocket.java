package com.metagards.metagames._TeenPatti;

import static com.metagards.metagames.Fragments.ActiveTables_BF.SEL_TABLE;
import static com.metagards.metagames.Utils.Variables.TEENPATTIPUBLIC;
...
import com.metagards.metagames.ApiClasses.Dealer;
...
import com.metagards.metagames._TeenPatti.menu.DialogRulesTeenpatti;
...
public class TeenPattiSocket extends BaseActivity {
    ...
    private static final String URL = "http://64.227.186.5:3002/teenpatti";
    Socket mSocket;
...
//                pStatus--;
                ...
                mProgress1.setProgress((int) ((int) pStatusprogress * 2));
...
//                mProgress.setProgress(100);
        ...
        counttimerforstartgame = new CountDownTimer(8000, 1000) {
            ...
            public void onFinish() {
                ...
                //  Toast.makeText(TeenPattiSocket.this, "Start Game", Toast.LENGTH_SHORT).show();
...
//                timertime);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //Toast.makeText(TeenPattiSocket.this, "Trigger", Toast.LENGTH_SHORT).show();
                        String resp = String.valueOf(args[0]);
                        Log.e("Status_Response", resp);
        ...
        mSocket.on("show-game", new Emitter.Listener() {
            @Override
            public void call(Object... args) {

                String resp = String.valueOf(args[0]);
                Log.e("ShowGame_Response", resp);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.e("Socket_Response", response);
        ...
        mSocket.on("slide-show", new Emitter.Listener() {
            @Override
            public void call(Object... args) {

                String resp = String.valueOf(args[0]);
                Log.e("SlideShow_Response", resp);
...
//
        ...
        mSocket.on("get-customise-table", new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    @Override
        ...
        mSocket.on("get-private-table", new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    @Override
        ...
        mSocket.on("see-card", new Emitter.Listener() {
            @Override
            public void call(Object... args) {

                String resp = String.valueOf(args[0]);
                Log.e("SeeCards_Response", resp);
...
//                                                Toast.LENGTH_LONG).show();
        ...
        mSocket.on("switch-table", new Emitter.Listener() {
            @Override
            public void call(Object... args) {

                String resp = String.valueOf(args[0]);
                Log.e("SwitchTable_Response", resp);
            ...
            public void onClick(View view) {
                ...
                if (playercount > 2) {
                    ...
                    Executors.newSingleThreadExecutor().execute(() -> {
                        ...
                        mSocket.emit("show-game", jsonObjectUser);
...
//                imgplayer5mainfirst.startAnimation(animMoveCardsPlayer5);
    ...
    private void AnimateCardstoPlayer(String players) {
        ...
        if (players.equals(PLAYER1)) {
            ...
            imgplayer2mainfirst.setVisibility(View.VISIBLE);
            imgplayer2mainfirst.startAnimation(animMoveCardsPlayer2);
        } else if (players.equals(PLAYER3)) {
            imgplayer3mainfirst.setVisibility(View.VISIBLE);
            imgplayer3mainfirst.startAnimation(animMoveCardsPlayer3);
        } else if (players.equals(PLAYER4)) {
            imgplayer4mainfirst.setVisibility(View.VISIBLE);
            imgplayer4mainfirst.startAnimation(animMoveCardsPlayer4);
        } else if (players.equals(PLAYER5)) {
            imgplayer5mainfirst.setVisibility(View.VISIBLE);
            imgplayer5mainfirst.startAnimation(animMoveCardsPlayer5);
        }
...
//        }
    ...
    private void getGame(final String event_name) {
...
//        Volley.newRequestQueue(this).add(stringRequest);
    ...
    private void getGame(final String event_name, final String boot_value) {
...
//                                Toast.LENGTH_LONG).show();
    ...
    private void GameLeave(final String value) {
        ...
        mSocket.emit("leave-table", jsonObjectUser);
            ...
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String resp = String.valueOf(args[0]);
                        Log.e("LeaveTable_Response", resp);
...
//third player
                            ...
                            JSONArray jsonArrayall_gameusers = jsonObject.getJSONArray("game_users");
...
//        }
    ...
    private void GamePack(final String type) {
        ...
        //params.put("user_id",prefs.getString("user_id", ""));
        try {
            jsonObjectPack.put("user_id", chaak_user_id);
            jsonObjectPack.put("token", prefs.getString("token", ""));
            jsonObjectPack.put("timeout", type);
        } catch (JSONException e) {
            e.printStackTrace();
        }

        mSocket.emit("pack-game", jsonObjectPack);
        mCountDownTimer1.cancel();
        mCountDownTimer2.cancel();
        mCountDownTimer3.cancel();
        mCountDownTimer4.cancel();
...
//        Volley.newRequestQueue(this).add(stringRequest);
    ...
    private void GameChhal() {
        ...
        JSONObject jsonObjectChaal = new JSONObject();
        SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
        try {
            jsonObjectChaal.put("user_id", prefs.getString("user_id", ""));
            jsonObjectChaal.put("plus", sentamounttype);
            jsonObjectChaal.put("token", prefs.getString("token", ""));
        } catch (JSONException e) {
            e.printStackTrace();
        }

        mSocket.emit("chaal", jsonObjectChaal);
...
//                    getTextView(R.id.tvSlideCountDown).setText((millisUntilFinished/1000)+" s");
    ...
    private void GameSideShow(final String prev_user_id) {
        ...
        JSONObject jsonObjectSlideshow = new JSONObject();
        SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
        try {
            jsonObjectSlideshow.put("user_id", prefs.getString("user_id", ""));
            jsonObjectSlideshow.put("prev_user_id", prev_user_id);
            jsonObjectSlideshow.put("token", prefs.getString("token", ""));
        } catch (JSONException e) {
            e.printStackTrace();
        }

        mSocket.emit("slide-show", jsonObjectSlideshow);
...
//        Volley.newRequestQueue(this).add(stringRequest);
    ...
    private void GameSideAction(final String slidshowid, final String slide_type) {
        ...
        JSONObject jsonObjectDoslideshow = new JSONObject();

        SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
        try {
            jsonObjectDoslideshow.put("user_id", prefs.getString("user_id", ""));
            jsonObjectDoslideshow.put("slide_id", slidshowid);
            jsonObjectDoslideshow.put("token", prefs.getString("token", ""));
            jsonObjectDoslideshow.put("type", slide_type);
        } catch (JSONException e) {
            e.printStackTrace();
        }

        mSocket.emit("do-slide-show", jsonObjectDoslideshow);
        ManageSlideShowAction(false);
...
//        Volley.newRequestQueue(this).add(stringRequest);
    ...
    private void SeeCards1() {
        ...
        mSocket.emit("see-card", jsonObjectUser);
...
//                                                Toast.LENGTH_LONG).show();
    ...
    private void GameTableChange() {
        ...
        mSocket.emit("switch-table", jsonObjectUser);
...
//                                            Toast.LENGTH_LONG).show();
    ...
    public void openBuyChipsDetails(View view) {
        Intent intent = new Intent(TeenPattiSocket.this, BuyChipsList.class);
        startActivity(intent);
    }
