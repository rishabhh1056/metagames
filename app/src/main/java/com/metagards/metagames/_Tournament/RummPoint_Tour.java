...
public class RummPoint_Tour extends BaseActivity implements Animation.AnimationListener {
    ...
    ImageView imgpl1glow,imgpl2glow,imgpl3glow,imgpl4glow,imgpl5glow,imgpl6glow,imgpl7glow,imgpl1winner,imgpl1winnerstar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rummypoint_tour);
...
//                    countvaue++;
    ...
    private void API_CALL_get_table() {
        ...
        params.put("tournament_id",""+tournament_id);
        ...
        ApiRequest.Call_Api(this, Const.take_seat, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
...
//                    LoadImage().load(Const.IMGAE_PATH + profile_pic).into(imgpl1circle);
    ...
    private void API_CALL_pack_game() {
        ...
        ApiRequest.Call_Api(this, Const.pack_game_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
    ...
    private void API_CALL_leave_table(final String value) {
        ...
        ApiRequest.Call_Api(this, Const.leave_table_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
    ...
    private void API_CALL_declare() {
        ...
        if(bt_declare.getTag().toString().trim().equalsIgnoreCase(DECLARE_BACK))
            url = Const.declare_back_RummyTournament;
        else
            url = Const.declare_RummyTournament;
...
//                    jsonObject.put("card_group",""+lnr_group_card.getTag());
    ...
    private void API_CALL_start_game() {
        ...
        ApiRequest.Call_Api(this, Const.start_game_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
    ...
    private void API_CALL_status() {
        ...
        ApiRequest.Call_Api(this, Const.RummyTournament_status, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
    ...
    private void API_CALL_getCardList() {
        ...
        ApiRequest.Call_Api(this, Const.my_card_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
                Log.v("my_card" , resp);
                try {
...
//            });
    ...
    private void API_CALL_drop_card(final ArrayList<CardModel> arrayList, final int countnumber) {
        ...
        ApiRequest.Call_Api(this, Const.drop_card_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
...
//                            ResetCardtoPosition(arrayList, countnumber);
    ...
    private void API_CALL_get_card() {
        ...
        ApiRequest.Call_Api(this, Const.get_card_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
    ...
    private void API_CALL_get_drop_card() {
        ...
        ApiRequest.Call_Api(this, Const.get_drop_card_RummyTournament, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
                Log.v("get_card" , " "+resp);
