package com.metagards.metagames._CarRoullete.menu;
...
import com.metagards.metagames._LuckJackpot.Model.JackpotLastWinHistory;
...
public class DialogCarRolloutelastWinHistory {

    Context context;
    Callback callback;
    private static DialogCarRolloutelastWinHistory mInstance;
    ...
    public static DialogCarRolloutelastWinHistory getInstance(Context context) {
        if (null == mInstance) {
            synchronized (DialogCarRolloutelastWinHistory.class) {
                if (null == mInstance) {
                    mInstance = new DialogCarRolloutelastWinHistory(context);
                }
            }
        }
     ...
     */
    public DialogCarRolloutelastWinHistory init(Context context) {
        try {
    ...
    private DialogCarRolloutelastWinHistory initDialog() {
    ...
    public DialogCarRolloutelastWinHistory(Context context) {
        this.context = context;
    }

    public DialogCarRolloutelastWinHistory() {
    }
    Dialog dialog;

    public DialogCarRolloutelastWinHistory show() {
    ...
    String game_id;
    public DialogCarRolloutelastWinHistory setRoomid(String game_id) {
