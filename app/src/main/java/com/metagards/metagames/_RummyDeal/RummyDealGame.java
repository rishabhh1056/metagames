package com.metagards.metagames._RummyDeal;
...
import com.metagards.metagames._RummyDeal.Fragments.DealGameUsersPoint_bt;
...
import static com.metagards.metagames.Utils.Variables.RUMMYGAMEDEAL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.rl_invite).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                shareMessage = Functions.inviteTableLink(context,table_id,RUMMYGAMEDEAL);
