...
public class BotsAdapterRight extends RecyclerView.Adapter<BotsAdapterRight.ViewHolder>{

    Context context;
    ArrayList<Bots_list> list;
    String entry_type="";

    public BotsAdapterRight(Context context, ArrayList<Bots_list> list) {
