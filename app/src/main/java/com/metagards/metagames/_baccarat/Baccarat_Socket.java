...
public class Baccarat_Socket extends BaseActivity implements View.OnClickListener{
    ...
    private static final  String URL = "http://64.227.186.5:3002/baccarat";
    Socket mSocket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSocket.connect();
        mSocket.emit("baccarat_timer", "baccarat_timer");

        Initialization();

        setDataonUser();

        mSocket.on("baccarat_timer", new Emitter.Listener() {
            @Override
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (intger == 1){
                            ...
                            ((TextView) findViewById(R.id.tvStartTimer)).setVisibility(View.GONE);
                            ...
                            ((TextView) findViewById(R.id.tvStartTimer)).setVisibility(View.VISIBLE);
        ...
        mSocket.on("baccarat_status", new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                runOnUiThread(new Runnable() {
                    @Override
