...
public class DialogBaccarat {

    Context context;
    Callback callback;
    private static DialogBaccarat mInstance;
    ...
    public static DialogBaccarat getInstance(Context context) {
        if (null == mInstance) {
            synchronized (DialogBaccarat.class) {
                if (null == mInstance) {
                    mInstance = new DialogBaccarat(context);
                }
            }
        }
     ...
     */
    public DialogBaccarat init(Context context) {
        try {
    ...
    private DialogBaccarat initDialog() {
    ...
    public DialogBaccarat(Context context) {
        this.context = context;
    }

    public DialogBaccarat() {
    }
    Dialog dialog;

    public DialogBaccarat show() {
    ...
    String game_id;
    public DialogBaccarat setRoomid(String game_id) {
